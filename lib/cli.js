...
// spell check from joint of 2 services' responses
function checkJoint() {
  ...
  hanspell.spellCheckByDAUM(sentence, HTTP_TIMEOUT, buildMap, function() {
    hanspell.spellCheckByPNU(sentence, HTTP_TIMEOUT, fixJointTypos, 
      writeFixedSentence);
  });
}
