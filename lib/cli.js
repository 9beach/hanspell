...
function fixTypo(input, output) {
  // in case input includes RegEsp escape characters
  try {
...
// callback function to build typo map from responses of server
...
// callback function to build joint typo map from responses of server
